/**
 * Project Data for Onuabuchi Chidera's Creative Portfolio
 * Categories: video-editing, brand-design, graphic-design, motion-graphics
 */
...
const projectsData = [
  ...
  },
  {
    ...
    caseStudy: {
      // description: "I edited a series of dynamic video projects for this client, focusing on cinematic pacing, rhythmic sound design, and polished color grading. Each video was crafted to capture attention within the first few seconds while maintaining a cohesive visual narrative throughout. Using Adobe Premiere Pro and DaVinci Resolve, I built tight music-synchronized cuts with layered Foley, smooth transitions, and custom color grades tailored to the client's brand tone.",
      videos: [
        {
          title: "Brand Launch Film",
          subtitle: "Hero brand introduction with cinematic pacing and sound design",
          src: "assets/02-video-projects/my-contents-today.mp4"
        },
        {
          title: "Social Media Campaign Cut",
          subtitle: "Fast-paced vertical and horizontal cuts for Instagram & TikTok",
          src: "assets/02-video-projects/V2.mp4"
        },
        {
          title: "Product Showcase Reel",
          subtitle: "Clean product-focused edit with motion graphics overlays",
          src: "assets/02-video-projects/V3.mp4"
        },
        {
          title: "Event Recap Highlight",
          subtitle: "Dynamic recap edit from a live brand activation event",
          src: "assets/02-video-projects/V4.mp4"
        },
        // {
        //   title: "Testimonial & Interview Edit",
        //   subtitle: "Multi-cam interview assembly with clean audio and lower thirds",
        //   src: "assets/02-video-projects/V5.mp4"
        // }
      ],
      gallery: [],
...
// Testimonials data matching Phase 4 / Step 11
